...
def parse_args():
    ...
    # Dataset parameters
    parser.add_argument("--dir", default="./pretrained_embeddings/MOCO/IMAGENET_50", help="dataset directory")
    ...
    parser.add_argument(
        "--pretrain_path", type=str, default="./saved_models/ae_weights/imagenet_50_e2e.zip", help="use pretrained weights"
    )
    parser.add_argument(
        "--use_labels_for_eval",
        action = "store_true",
...
def train_clusternet_with_alternations():
    ...
    print(torch.cuda.memory_cached(device="cuda"))
